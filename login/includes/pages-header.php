<!-- The header is used for pages inside 'pages'.
 --><!DOCTYPE html>
<html>
    <head>
    <meta charset="utf-8">
    ...
    <nav id="loginNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container for-nav">
            ...
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                ...
                <a class="navbar-brand page-scroll"><img class="yp-logo" src="../../../images/YourPeopleLogo.png"><span class="blue">Your</span><span class="orange">People</span></a>
            </div>
